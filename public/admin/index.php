<?php
ob_start();
require_once ('../cruzer/includes/config.php');
require_once ('../cruzer/includes/database.class.php');
$db = new database($pdo);
//session_start();
    ...
    <div class="cl-navblock">
      <div class="menu-space">
        <div class="content">
          ...
          <div class="side-user">
            <div class="avatar"><span style="font-family: 'Dosis', sans-serif; font-size:30px">AFRIFARES.COM 
            <?php $db->getMemID();	
					?>
            </span></div>
